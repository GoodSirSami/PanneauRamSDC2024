...
private:
	...
	void messageMode(std::string val);
	void messageMoteurA(std::string val);
	void messageMoteurB(std::string val);
	void messageMoteurC(std::string val);
	void messageRecette(std::string val);
	void messageRecetteGo(std::string val);
	void messagePoids(std::string val);
	void messageShopVac(std::string val);
